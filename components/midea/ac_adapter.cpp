...
// Custom fan mode display names (percentage-based)
const char *const Constants::FAN_AUTO = "Auto";
const char *const Constants::FAN_20 = "20%";
const char *const Constants::FAN_40 = "40%";
const char *const Constants::FAN_60 = "60%";
const char *const Constants::FAN_80 = "80%";
const char *const Constants::FAN_100 = "100%";
const char *const Constants::FAN_CUSTOM = "Custom";
